...
public class ChemiSounds {
  public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(Registries.SOUND_EVENT, ChemistryMod.MODID);

  //OtoLogic (https://otologic.jp)
  //Licensed under CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/)
  public static final DeferredHolder<SoundEvent, SoundEvent> KAGURA_LIGHT =
    SOUND_EVENTS.register("kagura_suzu_light",
      () -> SoundEvent.createVariableRangeEvent(
        ResourceLocation.fromNamespaceAndPath(ChemistryMod.MODID, "kagura_suzu_light")));
  public static final DeferredHolder<SoundEvent, SoundEvent> KAGURA_RESONANT =
    SOUND_EVENTS.register("kagura_suzu_resonant",
      () -> SoundEvent.createVariableRangeEvent(
        ResourceLocation.fromNamespaceAndPath(ChemistryMod.MODID, "kagura_suzu_resonant")));
  public static final DeferredHolder<SoundEvent, SoundEvent> KAGURA_SOLEMN =
    SOUND_EVENTS.register("kagura_suzu_solemn",
      () -> SoundEvent.createVariableRangeEvent(
        ResourceLocation.fromNamespaceAndPath(ChemistryMod.MODID, "kagura_suzu_solemn")));
  public static final DeferredHolder<SoundEvent, SoundEvent> KAGURA_BLESSING =
  ...
  //効果音ラボ
  public static final DeferredHolder<SoundEvent, SoundEvent> WIND_CHIME =
