...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DraftChamberBlockEntity>> DRAFT_CHAMBER =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ChemicalFermenterBlockEntity>> CHEMICAL_FERMENTER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FractionalDistillerBlockEntity>> FRACTIONAL_DISTILLER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FractionalDistillerSubBlockEntity>> FRACTIONAL_DISTILLER_SUB = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlastFurnaceSubBlockEntity>> BLAST_FURNACE_SUB = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<HeatFurnaceBlockEntity>> HEAT_FURNACE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ElectroLysisBlockEntity>> ELECTROLYSIS_DEVICE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DebugGeneratorBlockEntity>> GENERATOR_DEBUG = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DebugEnergyConsumerBlockEntity>> ENERGYCONSUMER_DEBUG = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ElectricCableCopperBlockEntity>> CABLE_COPPER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ElectricCableGoldBlockEntity>> CABLE_GOLD = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ElectricCableRefinedCopperBlockEntity>> CABLE_REFINED_COPPER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ElectricCableHVBlockEntity>> CABLE_ALUMINIUM = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FuelGeneratorBlockEntity>> GENERATOR_FUEL = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FluidFuelGeneratorBlockEntity>> GENERATOR_FLUID = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<RadioIsotopeGeneratorBlockEntity>> GENERATOR_RADIOISOTOPE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SolarPowerGeneratorBlockEntity>> GENERATOR_SOLAR = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LeadBatteryBlockEntity>> LEAD_BATTERY = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<AdvancedLeadBatteryBlockEntity>> ADVANCED_LEAD_BATTERY = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TradingStallBlockEntity>> TRADING_STALL = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PipeCopperBlockEntity>> PIPE_COPPER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PipeGoldBlockEntity>> PIPE_GOLD = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PipePVCBlockEntity>> PIPE_PVC = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CopperTankBlockEntity>> COPPER_TANK = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DissolverBlockEntity>> DISSOLVER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<StackLampBlockEntity>> STACK_LAMP = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<AirSeparatorBlockEntity>> AIR_SEPARATOR = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<HaberBoschBlockEntity>> HABER_BOSCH = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<HydrogenReductorBlockEntity>> HYDROGEN_REDUCTOR = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PEMDeviceBlockEntity>> PEM_DEVICE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<AutoExperimenterBlockEntity>> AUTO_EXPERIMENTER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LargeTankCoreBlockEntity>> LARGE_TANK_CORE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LargeTankInterfaceBlockEntity>> LARGE_TANK_INTERFACE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<OnsenMinerBlockEntity>> ONSEN_MINER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<OnsenFillerBlockEntity>> ONSEN_FILLER = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FiltrationDeviceBlockEntity>> FILTRATION_DEVICE = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ChemiSignBlockEntity>> SIGN = 
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ChemiHangingSignBlockEntity>> HANGING_SIGN = 
