...
public class ChemiGasObject implements ChemiFluidInterface {
  ...
  public ChemiGasObject(String name, int color){
    this.name=name;
    this.FluidType = ChemiFluidTypes.FLUID_TYPES.register(name,() -> new OrganicGasType(color));
