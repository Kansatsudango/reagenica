...
public class ChemiFluidBurnMap {
  ...
  public static void register(){
    fluidBurnMap.put(ChemiFluids.CRUDE_OIL.getFluid(), new ChemiFluidBurnrate(40,20));
    fluidBurnMap.put(ChemiFluids.DIESEL_FUEL.getFluid(), new ChemiFluidBurnrate(40,60));
    fluidBurnMap.put(ChemiFluids.ETHANOL.getFluid(), new ChemiFluidBurnrate(80,30));
  }
