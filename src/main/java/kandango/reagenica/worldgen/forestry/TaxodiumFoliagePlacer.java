...
public class TaxodiumFoliagePlacer extends FoliagePlacer{
  public static final Codec<TaxodiumFoliagePlacer> CODEC = 
        RecordCodecBuilder.create(
          instance -> foliagePlacerParts(instance)
            .and(Codec.INT.fieldOf("height").forGetter(p -> p.height))
            .apply(instance, TaxodiumFoliagePlacer::new)
        );

  private final int height;
  public TaxodiumFoliagePlacer(IntProvider radius, IntProvider offset, int height){
    super(radius, offset);
    this.height = height;
  }
