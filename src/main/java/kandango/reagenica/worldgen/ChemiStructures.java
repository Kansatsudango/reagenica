...
public class ChemiStructures {
  ...
  public static final DeferredHolder<StructureType<MegaCraterStructure>> MEGA_CRATER = STRUCTURE_TYPES.register(
    "mega_crater", () -> () -> MegaCraterStructure.CODEC);

  public static final DeferredHolder<StructurePieceType>
    MEGA_CRATER_PIECE =
