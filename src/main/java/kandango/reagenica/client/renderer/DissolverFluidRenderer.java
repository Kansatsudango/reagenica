...
public class DissolverFluidRenderer implements BlockEntityRenderer<DissolverBlockEntity>{
  public DissolverFluidRenderer(BlockEntityRendererProvider.Context context){
  }

  @Override
  public void render(@Nonnull DissolverBlockEntity eld, float partialTick, @Nonnull PoseStack poseStack, 
