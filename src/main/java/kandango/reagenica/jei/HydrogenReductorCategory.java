...
public class HydrogenReductorCategory implements IRecipeCategory<HydrogenReductorRecipe>{
  public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("reagenica", "hydrogen_reductor");
  private final IDrawable background;
  private final IDrawable icon;

  public HydrogenReductorCategory(IJeiHelpers helpers){
    this.background = helpers.getGuiHelper().createDrawable(ResourceLocation.fromNamespaceAndPath("reagenica", "textures/gui/container/hydrogen_reductor.png"), 0, 0, 176, 80);
