...
public class ChemiVillagerTrades {
  ...
  public static void addGeologistTrades(Int2ObjectMap<List<ItemListing>> trades){
    ...
    expert.add(buy(AQUAMARINE.SHARD_ITEM.get(), 2, 1, 16, 18, 0.05f));
    expert.add(buy(EMERALD.SHARD_ITEM.get(), 2, 1, 16, 18, 0.05f));
    expert.add(buy(CITRINE.SHARD_ITEM.get(), 2, 1, 16, 18, 0.05f));
    expert.add(buy(ROSE_QUARTZ.SHARD_ITEM.get(), 2, 1, 16, 18, 0.05f));
    expert.add(buy(RED_BERYL.SHARD_ITEM.get(), 2, 1, 16, 18, 0.05f));
