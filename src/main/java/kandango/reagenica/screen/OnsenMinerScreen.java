...
public class OnsenMinerScreen extends AbstractContainerScreen<OnsenMinerMenu> {
  ...
  public OnsenMinerScreen(OnsenMinerMenu menu, Inventory inv, Component title) {
    super(menu, inv, title);
    this.imageHeight = 165;
    this.inventoryLabelY = this.imageHeight - 94;
    components.add(new TankComponent(menu.getFluidTank(), 62, 18, menu.getBlockEntity().getBlockPos()));
  }
