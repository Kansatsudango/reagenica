...
public class WoodFamily {
  ...
  public WoodFamily(String name, Supplier<AbstractTreeGrower> grower){
    ...
    this.SAPLING = ChemiBlocks.BLOCKS.register(name+"_sapling", () -> new SaplingBlock(grower.get(),BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING)));
    ...
    this.TRAPDOOR = ChemiBlocks.BLOCKS.register(name+"_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_TRAPDOOR), setType));
    this.TRAPDOOR_ITEM = ChemiBlocks.ITEMS.register(name+"_trapdoor", () -> new BlockItem(TRAPDOOR.get(), new Item.Properties()));
    this.DOOR = ChemiBlocks.BLOCKS.register(name+"_door", () -> new DoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_DOOR), setType));
    this.DOOR_ITEM = ChemiBlocks.ITEMS.register(name+"_door", () -> new BlockItem(DOOR.get(), new Item.Properties()));
    this.BUTTON = ChemiBlocks.BLOCKS.register(name+"_button", () -> new ButtonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_BUTTON), setType, 30, true));
    this.BUTTON_ITEM = ChemiBlocks.ITEMS.register(name+"_button", () -> new BlockItem(BUTTON.get(), new Item.Properties()));
    this.PRESSURE_PLATE = ChemiBlocks.BLOCKS.register(name+"_pressure_plate", () -> new PressurePlateBlock(Sensitivity.EVERYTHING, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_BUTTON), setType));
