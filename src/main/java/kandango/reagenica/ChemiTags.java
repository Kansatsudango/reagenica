...
public class ChemiTags {
  ...
  public static class Items {
    ...
    public static final TagKey<Item> FARMING_BAG_ACCEPT =
      TagKey.create(Registries.ITEM, new ResourceLocation("reagenica", "farming_bag_accept"));
    public static final TagKey<Item> CRYSTAL_SHARDS =
      TagKey.create(Registries.ITEM, new ResourceLocation("reagenica", "crystal_shards"));
